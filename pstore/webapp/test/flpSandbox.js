		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "P店舗日計表",
									"targetURL": "#comshinpstorepstore-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comshinpstorepstore-display": {
								"semanticObject": "comshinpstorepstore",
								"action": "display",
								"description": "P店舗日計表",
								"title": "P店舗日計表",
								"signature": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.shin.pstore.pstore",
									"url": sap.ui.require.toUrl("com/shin/pstore/pstore")
								}
							}
						}
					}
