		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Daily Balance Approval",
									"targetURL": "#FICOdailybalanceapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FICOdailybalanceapproval-display": {
								"semanticObject": "FICOdailybalanceapproval",
								"action": "display",
								"description": "Daily Balance Approval",
								"title": "Daily Balance Approval",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=FICO.dailybalanceapproval",
									"url": sap.ui.require.toUrl("FICO/dailybalanceapproval")
								}
							}
						}
					}
