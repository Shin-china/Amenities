		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Daily Balnace ABR",
									"targetURL": "#pstore004-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FICOdailybalanceabr-display": {
								"semanticObject": "pstore004",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=FICO.pstore004",
									"url": sap.ui.require.toUrl("FICO/pstore004")
								}
							}
						}
					}
