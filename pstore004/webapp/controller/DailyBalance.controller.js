sap.ui.define([
	...
	return BaseController.extend("FICO.pstore004.controller.DailyBalance", {
        ...
        _getMessagePopover: function () {
			...
			if (!this._pMessagePopover) {
				this._pMessagePopover = Fragment.load({
					id: oView.getId(),
					name: "FICO.pstore004.view.fragment.MessagePopover"
        ...
        onPrintPDF: function (oEvent) {
            ...
            var sUrl = "/sap/opu/odata/sap/ZZAMAREA_SRV/ZzExportSet(KAISHA_CD='" + sKAISHA_CD + "',KIHYO_NO='" + sKIHYO_NO + "')/$value";
            // window.open(sUrl, "_blank");
            var sShop = sTENPO_CD;
            if (sShop.length == 3) {
                sShop = "0" + sShop;
            }
            var sFielName = "Amenities_アムエリア_" + sShop + "_" + sEIGYO_BI + sNIKKEIHYO_STATUS;
