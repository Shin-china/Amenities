						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#FICOdailybalanceabr-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"FICOdailybalanceabr-display": {
								"semanticObject": "FICOdailybalanceabr",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=FICO.dailybalanceabr",
									"url": sap.ui.require.toUrl("FICO/dailybalanceabr")
								}
							}
						}
					}
