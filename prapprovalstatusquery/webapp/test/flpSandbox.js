		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "PR Approval status query",
									"targetURL": "#MMprapprovalstatusquery-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"MMprapprovalstatusquery-display": {
								"semanticObject": "MMprapprovalstatusquery",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=MM.prapprovalstatusquery",
									"url": sap.ui.require.toUrl("MM/prapprovalstatusquery")
								}
							}
						}
					}
